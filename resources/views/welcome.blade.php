...
@section('content')
    ...
    <div class="relative flex flex-col bg-gray-100 bg-center sm:flex sm:justify-center sm:items-center bg-dots dark:bg-gray-900 selection:bg-indigo-500 selection:text-white">
        ...
        @if (Route::has('login'))
            ...
            >
                @auth
                    ...
                    <div>
                        <a href="{{ route('users.show', ["username" => auth()->user()->name]) }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-indigo-500">Profile</a>
        ...
        <div class="pb-2 px-4 sm:p-6 mx-auto sm:w-[65%] lg:p-8">
